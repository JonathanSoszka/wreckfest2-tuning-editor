# Contributing — the save format

This is the reverse-engineering reference for anyone (human or AI) working on the Wreckfest 2 save
format and this codebase. If you just want to *use* the app, see the [README](README.md).
